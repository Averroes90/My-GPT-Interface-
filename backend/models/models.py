...
class Interaction(db.Model):
    ...
    prompt_token_count = db.Column(db.Integer, nullable=False)  # New field for token count of the prompt
    response_token_count = db.Column(db.Integer, nullable=False)  # New field for token count of the response
